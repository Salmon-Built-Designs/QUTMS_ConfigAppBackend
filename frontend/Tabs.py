...
# Code adapted from https://justpy.io/tutorial/custom_components/#tab-group-component

class Tabs(Div):

    tab_label_classes = 'overflow-hidden cursor-pointer text-gray-600 py-2 px-6 block hover:text-blue-500 focus:outline-none'
    tab_label_classes_selected = 'overflow-hidden cursor-pointer text-gray-600 py-2 px-6 block hover:text-blue-500 focus:outline-none text-blue-900 border-b-2 font-medium border-blue-500'
    ...
    content_classes = 'relative overflow-hidden border flex flex-1'
    ...
    def set_content_div(self, tab):
        ...
        self.content_div.set_classes(self.content_classes)
        #self.content_div.style = f'height: {self.content_height}px'
        self.content_div.style = f'height: {self.content_height}vh'
